      ...
      <Box sx={{ py: 8, backgroundColor: 'white' }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              Explore our handpicked selection of featured destinations and activities
            </Typography>
          </Box>
              ...
              <Grid container spacing={2}>
                {filteredActivities
                  ...
                  >
                    <Box
                      component="img"
                      src={activity.images && activity.images.length > 0 ? activity.images[0] : 'https://via.placeholder.com/400x300?text=No+Image'}
                      alt={activity.name}
